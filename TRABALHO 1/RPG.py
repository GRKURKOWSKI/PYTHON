...
while vida_heroi > 0 and vida_monstro > 0:
    ...
    ataque_meu = int(input("Qual a força do seu ataque? (1 a 50): "))
    if ataque_meu < 1 or ataque_meu > 50:
        print("Ixi, valor errado! Digite um número de 1 a 50.")
        continue
        
    ataque_bicho = int(input("Qual a força do ataque do monstro? (1 a 50): "))
    if ataque_bicho < 1 or ataque_bicho > 50:
        print("Ixi, valor errado! Digite um número de 1 a 50.")
        continue
